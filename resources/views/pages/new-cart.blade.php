              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input
                    ...
                    id="address_one"
                    name="address_one"
                    value="{{ old('address_one', $cart->user->address_one) }}"
                  />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input
                    ...
                    id="address_two"
                    name="address_two"
                    value="{{ old('address_two', $cart->user->address_two) }}"
                  />
                </div>
              </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input
                    ...
                    id="zip_code"
                    name="zip_code"
                    value="{{ old('zip_code', $cart->user->zip_code) }}"
                  />
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input
                    ...
                    id="phone_number"
                    name="phone_number"
                    value="{{ old('phone_number', $cart->user->phone_number) }}"
                  />
                </div>
              </div>
